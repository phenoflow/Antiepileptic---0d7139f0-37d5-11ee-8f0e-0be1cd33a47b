...
codes = [{"code":"dnb7.","system":"readv2"},{"code":"dnb8.","system":"readv2"},{"code":"dnbJ.","system":"readv2"},{"code":"dnbK.","system":"readv2"},{"code":"dnbL.","system":"readv2"},{"code":"dnbM.","system":"readv2"},{"code":"dnbn.","system":"readv2"},{"code":"dnbo.","system":"readv2"},{"code":"dnbp.","system":"readv2"},{"code":"dnbq.","system":"readv2"},{"code":"dnbr.","system":"readv2"},{"code":"dnbs.","system":"readv2"},{"code":"dnbt.","system":"readv2"},{"code":"dnbv.","system":"readv2"},{"code":"dnby.","system":"readv2"}];
REQUIRED_CODES = 1;
